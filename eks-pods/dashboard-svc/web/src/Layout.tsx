...
const NAV: { section: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/wh-approve',      label: '승인 큐',           desc: '권역 내 재분배 / 외부발주 승인 대기',     allow: 'WH' },
      { to: '/wh-transfer',     label: '권역 이동',         desc: '수도권 ↔ 영남 도서 이동 (양쪽 승인 필요)', allow: 'WH' },
      { to: '/wh-instructions', label: '출고/입고 지시서',  desc: '오늘 처리할 출고와 입고 (신간 별도)',     allow: 'WH' },
