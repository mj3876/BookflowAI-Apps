...
const STORES: { id: number; name: string; wh: number }[] = [
  ...
  { id: 5, name: "신촌점", wh: 1 },
  { id: 6, name: "용산점", wh: 1 },
  { id: 7, name: "부산 서면점", wh: 2 },
  { id: 8, name: "대구 동성점", wh: 2 },
  { id: 9, name: "울산 삼산점", wh: 2 },
  { id: 10, name: "대구 교대점", wh: 2 },
  { id: 11, name: "부산 센텀점", wh: 2 },
  { id: 12, name: "포항 양덕점", wh: 2 },
];
    ...
    <div className="min-h-screen bg-bf-bg flex items-center justify-center p-6">
      <div className="w-full max-w-3xl">
        <div className="text-center mb-10">
          <h1 className="text-2xl font-bold m-0 mb-2 text-bf-text">
            📚 BookFlow
          </h1>
          <p className="text-bf-muted text-sm m-0">
            도서 유통 AI 통합 물류·재고 관리 플랫폼
          </p>
          <p className="text-bf-muted text-[11px] mt-2">
            Phase γ Entra ID OIDC 활성 · 아래 "Microsoft 로그인" 권장 · 개발용
            mock 도 가능
          </p>
          {/* CICD 검증 배지 — 영상 시연용 */}
          <div className="mt-3 inline-block px-4 py-1.5 rounded-full bg-green-500/20 text-green-400 text-sm font-semibold border border-green-500/40">
            ✅ CI/CD 검증 완료
          </div>
        </div>
        ...
        <div className="mb-6 text-center">
          ...
          <div className="text-[11px] text-bf-muted mt-2">
            BookFlow-Internal App · BF-Admin / BF-HeadQuarter / BF-Logistics /
            BF-Branch 그룹 매핑
          </div>
        </div>
          ...
          {ROLES.map((r) => (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-base font-semibold text-bf-text">
                  {r.label}
                </span>
              </div>
        ...
        <div className="mt-10 text-center text-[11px] text-bf-muted">
          V6.4 · MSA 7 Pod + 1 CronJob + 7 Lambda · Real-time POS / Spike
          Detection
        </div>
      </div>
    </div>
